...
function sort(compare, elements) {
    if (Array.isArray(elements)) {
        ...
        const leftElementsSorted = sort(compare, leftElements);//[1]
        const rightElementsSorted = sort(compare, rightElements);//[1,1] => //leftElements[1] rightElements[1] => // leftElementsSorted[1] rightES[1]
